...
namespace ChairtyApplication.Controllers
{
    public class PermissionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,RuleId")] Permission permission)
        {
            ...
            ViewBag.RuleId = new SelectList(db.UserRules, "Id", "RuleName", permission.RuleId);
            return View(permission);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,RuleId")] Permission permission)
        {
            if (ModelState.IsValid)
            {
